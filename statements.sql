...
-- PASO 1
-- Tu código aquí
CREATE TABLE usuarios (id_usuario INT AUTO_INCREMENT PRIMARY KEY,nombre VARCHAR(50) NOT NULL,apellido VARCHAR(100) NOT NULL,email VARCHAR(100) NOT NULL,edad INT);
-- Tu código aquí
...
-- PASO 3
-- Tu código aquí
ALTER TABLE usuarios ADD COLUMN id_rol INT; ALTER TABLE usuarios ADD CONSTRAINT fk_usuarios_roles 
...
-- PASO 4
-- Tu código aquí
SELECT u.id_usuario, u.nombre, u.apellido, u.email, u.edad, r.nombre_rol, c.nombre_categoria FROM usuarios u JOIN roles r ON u.id_rol = r.id_rol
